...
for u in range(1000):
    ...
    # 合套方案
    genes = [0, 0, 0, 1, 1, 1, 1, 1, 0, 1, 9, 8, 6, 1, 2, 0, 4, 5, 3, 7, 2, 0, 4, 6, 7, 1, 8, 9, 5, 3, 1, 3, 7, 5, 9, 6, 4, 0, 2, 8]
    ...
    if num_zu == 1:
        ...
        pro =[0.19303592 ,0.02734946, 0.13136078 ,0.11996224, 0.26677652, 0.26151507]
    # print(pro)
    t_w = []
    t_n = []
    t_g = []
    ...
    # LNS_ 迭代1000000
    # [0, 4, 8, 5, 6, 7, 9, 1, 3, 2, 9, 0, 4, 6, 5, 7, 1, 3, 2, 8, 8, 2, 3, 1, 7, 6, 5, 4, 9, 0]
    # 1.5327196495945097
    # [0.07087646 0.06087227 0.06191189 0.11710929 0.18966897 0.17509236
    #  0.08474163 0.23972713]

    # PSO:结果
    # 当前代编码： [1, 1, 1, 0, 0, 0, 1, 1, 1, 0, 5, 1, 7, 3, 6, 9, 8, 0, 2, 4, 5, 6, 1, 3, 0, 4, 7, 9, 2, 8, 2, 7, 6, 4, 0, 3, 1, 9, 8, 5]
    # 当前代游隙指标： 1.5924201184500244
    # 当前代对应的分组概率： [0.15471555 0.27752851 0.04431598 0.30753758 0.08152572 0.13437667]
    # 当前代编码： [1, 1, 0, 1, 0, 1, 1, 1, 0, 0, 2, 1, 7, 3, 6, 9, 8, 0, 4, 5, 2, 8, 1, 3, 0, 4, 6, 7, 9, 5, 8, 5, 6, 7, 4, 0, 3, 1, 9, 2]
    # 当前代游隙指标： 1.7595669958773013
    # 当前代对应的分组概率： [0.15598504 0.24223089 0.16656722 0.11267087 0.20051809 0.1220279 ]


    # new_result
    # 最终代编码： [0, 0, 0, 1, 1, 1, 1, 1, 0, 1, 9, 8, 6, 1, 2, 0, 4, 5, 3, 7, 2, 0, 4, 6, 7, 1, 8, 9, 5, 3, 1, 3, 7, 5, 9, 6, 4, 0, 2, 8]
    # 最终代游隙指标： 1.8294283646293432
    # 最终代对应的分组概率： [0.19303592 0.02734946 0.13136078 0.11996224 0.26677652 0.26151507]
    # LNS划分运行时间： 9519